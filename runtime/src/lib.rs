...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-arturo"),
	impl_name: create_runtime_str!("node-arturo"),
	authoring_version: 1,
	spec_version: 2,
	impl_version: 1,
...
impl pallet_workflow_engine::Config for Runtime {
	type Event = Event;
	type Currency = Balances;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		WorkflowEngine: pallet_workflow_engine::{Pallet, Call, Storage, Event<T>},
	}
);
